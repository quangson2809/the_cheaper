...
import com.example.the_cheaper.infrastructure.persistence.repository.*;
...
public class DataSeeder implements CommandLineRunner {
    ...
    private final JpaOptionAttributeRepository optionAttributeRepository;
    private final JpaOptionValueRepository optionValueRepository;
    ...
    public void run(String... args) {
        ...
        // ===================== ROLES (2 bản ghi) =====================
        RoleEntity roleUser = roleRepository.save(RoleEntity.builder().name("ROLE_USER").build());
        RoleEntity roleAdmin = roleRepository.save(RoleEntity.builder().name("ROLE_ADMIN").build());
        log.info("Seeded {} roles", roleRepository.count());

        // ===================== ACCOUNTS (10 bản ghi) =====================
        String hashedPassword = passwordEncoder.encode("Password123!");
        List<AccountEntity> accounts = accountRepository.saveAll(List.of(
                AccountEntity.builder().name("Nguyễn Văn An").email("an.nguyen@example.com").phone("0901234567").passwordHash(hashedPassword).role(roleUser).rewardPoint(150).build(),
                AccountEntity.builder().name("Trần Thị Bình").email("binh.tran@example.com").phone("0912345678").passwordHash(hashedPassword).role(roleUser).rewardPoint(320).build(),
                AccountEntity.builder().name("Lê Văn Cường").email("cuong.le@example.com").phone("0923456789").passwordHash(hashedPassword).role(roleUser).rewardPoint(80).build(),
                AccountEntity.builder().name("Phạm Thị Dung").email("dung.pham@example.com").phone("0934567890").passwordHash(hashedPassword).role(roleUser).rewardPoint(500).build(),
                AccountEntity.builder().name("Hoàng Văn Em").email("em.hoang@example.com").phone("0945678901").passwordHash(hashedPassword).role(roleUser).rewardPoint(210).build(),
                AccountEntity.builder().name("Vũ Thị Phương").email("phuong.vu@example.com").phone("0956789012").passwordHash(hashedPassword).role(roleUser).rewardPoint(0).build(),
                AccountEntity.builder().name("Đặng Văn Giang").email("giang.dang@example.com").phone("0967890123").passwordHash(hashedPassword).role(roleUser).rewardPoint(95).build(),
                AccountEntity.builder().name("Bùi Thị Hoa").email("hoa.bui@example.com").phone("0978901234").passwordHash(hashedPassword).role(roleUser).rewardPoint(440).build(),
                AccountEntity.builder().name("Ngô Văn Inh").email("inh.ngo@example.com").phone("0989012345").passwordHash(hashedPassword).role(roleUser).rewardPoint(60).build(),
                AccountEntity.builder().name("Admin Hệ Thống").email("admin@example.com").phone("0990000000").passwordHash(hashedPassword).role(roleAdmin).rewardPoint(0).build()
        ));
        ...
        OptionAttributeEntity attrWidth = optionAttributeRepository.save(OptionAttributeEntity.builder().name("Độ Rộng").build());
        OptionAttributeEntity attrSole = optionAttributeRepository.save(OptionAttributeEntity.builder().name("Loại Đế").build());
        OptionAttributeEntity attrClosure = optionAttributeRepository.save(OptionAttributeEntity.builder().name("Khóa Cài").build());
        OptionAttributeEntity attrUpper = optionAttributeRepository.save(OptionAttributeEntity.builder().name("Phần Mũ Giày").build());
        OptionAttributeEntity attrSeason = optionAttributeRepository.save(OptionAttributeEntity.builder().name("Mùa Phù Hợp").build());
        ...
        OptionValueEntity genderMale = optionValueRepository.save(OptionValueEntity.builder().value("Nam").optionAttribute(attrGender).build());
        OptionValueEntity genderFemale = optionValueRepository.save(OptionValueEntity.builder().value("Nữ").optionAttribute(attrGender).build());
        OptionValueEntity genderUnisex = optionValueRepository.save(OptionValueEntity.builder().value("Unisex").optionAttribute(attrGender).build());
        OptionValueEntity soleRubber = optionValueRepository.save(OptionValueEntity.builder().value("Đế Cao Su").optionAttribute(attrSole).build());
        OptionValueEntity soleFoam = optionValueRepository.save(OptionValueEntity.builder().value("Đế Foam").optionAttribute(attrSole).build());
        ...
        ProductEntity p1 = productRepository.save(ProductEntity.builder()
                ...
                .material("Lưới thoáng khí kết hợp da tổng hợp")
        ...
        ProductEntity p2 = productRepository.save(ProductEntity.builder()
                .name("Adidas Ultraboost 22").description("Công nghệ Boost tạo ra cảm giác phản hồi năng lượng tuyệt vời cho người chạy bộ.")
                .material("Primeknit+").comparePrice(new BigDecimal("4200000")).salePrice(new BigDecimal("3800000"))
        ...
        ProductEntity p3 = productRepository.save(ProductEntity.builder()
                .name("Puma RS-X Reinvention").description("Thiết kế retro cách tân với hệ thống đệm RS mạnh mẽ, phong cách đường phố hiện đại.")
                .material("Vải dệt và da tổng hợp").comparePrice(new BigDecimal("2800000")).salePrice(new BigDecimal("2300000"))
        ...
        ProductEntity p4 = productRepository.save(ProductEntity.builder()
                .name("Nike Phantom GX Elite FG").description("Giày bóng đá chuyên nghiệp với công nghệ Flyknit ôm sát bàn chân.")
                .material("Flyknit").comparePrice(new BigDecimal("6500000")).salePrice(new BigDecimal("5800000"))
        ...
        ProductEntity p5 = productRepository.save(ProductEntity.builder()
                .name("Adidas Dame 8").description("Giày bóng rổ của ngôi sao Damian Lillard với đế Lightstrike Pro siêu nhẹ.")
                .material("Synthetic upper").comparePrice(new BigDecimal("3800000")).salePrice(new BigDecimal("3200000"))
        ...
        ProductEntity p6 = productRepository.save(ProductEntity.builder()
                .name("Converse Chuck Taylor All Star Classic").description("Biểu tượng thời trang mọi thời đại với thiết kế canvas kinh điển không bao giờ lỗi mốt.")
                .material("Vải Canvas 100%").comparePrice(new BigDecimal("1500000")).salePrice(new BigDecimal("1200000"))
        ...
        ProductEntity p7 = productRepository.save(ProductEntity.builder()
                .name("Vans Old Skool Classic").description("Giày skate cổ điển với sọc Side Stripe đặc trưng của thương hiệu Vans.")
                .material("Canvas và Da Lộn").comparePrice(new BigDecimal("1800000")).salePrice(new BigDecimal("1500000"))
        ...
        ProductEntity p8 = productRepository.save(ProductEntity.builder()
                .name("New Balance 574 Core").description("Giày thể thao cổ điển thoải mái cho mọi hoạt động hàng ngày với đế ENCAP.")
                .material("Suede và Mesh").comparePrice(new BigDecimal("2200000")).salePrice(new BigDecimal("1900000"))
        ...
        ProductEntity p9 = productRepository.save(ProductEntity.builder()
                .name("Under Armour HOVR Sonic 5").description("Giày chạy bộ kết nối công nghệ MapMyRun theo dõi hiệu suất tập luyện.")
                .material("Mesh thoáng khí").comparePrice(new BigDecimal("3000000")).salePrice(new BigDecimal("2600000"))
        ...
        ProductEntity p10 = productRepository.save(ProductEntity.builder()
                .name("Reebok Classic Leather Legacy").description("Phiên bản hiện đại của mẫu giày classic huyền thoại với chất liệu da cao cấp.")
                .material("Full-grain leather").comparePrice(new BigDecimal("2500000")).salePrice(new BigDecimal("2100000"))
        ...
        ProductVariantEntity v1 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("NIKE-AM270-BLK-40").stock(50).overiteSalePrice(null)
        ...
        ProductVariantEntity v2 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("NIKE-AM270-WHT-41").stock(35).overiteSalePrice(null)
        ...
        ProductVariantEntity v3 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("ADID-UB22-GRY-40").stock(40).overiteSalePrice(new BigDecimal("3600000"))
        ...
        ProductVariantEntity v4 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("ADID-UB22-BLK-42").stock(25).overiteSalePrice(null)
        ...
        ProductVariantEntity v5 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("PUMA-RSX-RED-39").stock(30).overiteSalePrice(new BigDecimal("2100000"))
        ...
        ProductVariantEntity v6 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("NIKE-PHG-BLK-41").stock(20).overiteSalePrice(null)
        ...
        ProductVariantEntity v7 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("NIKE-PHG-WHT-42").stock(15).overiteSalePrice(null)
        ...
        ProductVariantEntity v8 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("ADID-D8-BLU-40").stock(45).overiteSalePrice(null)
        ...
        ProductVariantEntity v9 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("CONV-CT-BLK-38").stock(60).overiteSalePrice(null)
        ...
        ProductVariantEntity v10 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("CONV-CT-WHT-39").stock(55).overiteSalePrice(null)
        ...
        ProductVariantEntity v11 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("VANS-OS-BLK-40").stock(70).overiteSalePrice(null)
        ...
        ProductVariantEntity v12 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("VANS-OS-WHT-41").stock(65).overiteSalePrice(null)
        ...
        ProductVariantEntity v13 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("NB-574-GRY-39").stock(40).overiteSalePrice(new BigDecimal("1750000"))
        ...
        ProductVariantEntity v14 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("NB-574-BLU-42").stock(30).overiteSalePrice(null)
        ...
        ProductVariantEntity v15 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("UA-HS5-BLK-40").stock(35).overiteSalePrice(null)
        ...
        ProductVariantEntity v16 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("UA-HS5-BLU-41").stock(28).overiteSalePrice(new BigDecimal("2400000"))
        ...
        ProductVariantEntity v17 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("REEB-CL-WHT-38").stock(45).overiteSalePrice(null)
        ...
        ProductVariantEntity v18 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("REEB-CL-BLK-40").stock(38).overiteSalePrice(null)
        ...
        ProductVariantEntity v19 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("PUMA-RSX-BLK-41").stock(22).overiteSalePrice(null)
        ...
        ProductVariantEntity v20 = productVariantRepository.save(ProductVariantEntity.builder()
                .sku("ADID-D8-RED-42").stock(18).overiteSalePrice(new BigDecimal("3000000"))
        ...
        List<AddressEntity> addresses = List.of(
                AddressEntity.builder().location("123 Nguyễn Huệ, Quận 1, TP.HCM").phone("0901234567").account(accounts.get(0)).build(),
                AddressEntity.builder().location("45 Trần Hưng Đạo, Quận 5, TP.HCM").phone("0912345678").account(accounts.get(1)).build(),
                AddressEntity.builder().location("88 Lê Lợi, Quận 3, TP.HCM").phone("0923456789").account(accounts.get(2)).build(),
                AddressEntity.builder().location("12 Hoàng Diệu, Quận 4, TP.HCM").phone("0934567890").account(accounts.get(3)).build(),
                AddressEntity.builder().location("67 Cách Mạng Tháng 8, Quận 10, TP.HCM").phone("0945678901").account(accounts.get(4)).build(),
                AddressEntity.builder().location("30 Phan Đình Phùng, Quận Phú Nhuận, TP.HCM").phone("0956789012").account(accounts.get(5)).build(),
                AddressEntity.builder().location("99 Đinh Tiên Hoàng, Quận Bình Thạnh, TP.HCM").phone("0967890123").account(accounts.get(6)).build(),
                AddressEntity.builder().location("15 Lý Thường Kiệt, Quận Tân Bình, TP.HCM").phone("0978901234").account(accounts.get(7)).build(),
                AddressEntity.builder().location("22 Trường Chinh, Quận 12, TP.HCM").phone("0989012345").account(accounts.get(8)).build(),
                AddressEntity.builder().location("55 Nguyễn Oanh, Quận Gò Vấp, TP.HCM").phone("0901111111").account(accounts.get(0)).build()
        );
        ...
        List<OrderEntity> orders = orderRepository.saveAll(List.of(
                OrderEntity.builder().account(accounts.get(0)).status(OrderStatus.DELIVERED)
                        .subTotal(new BigDecimal("2990000")).finalTotal(new BigDecimal("2990000"))
                        .receiverName("Nguyễn Văn An").receiverPhone("0901234567")
                        .receiverAddress("123 Nguyễn Huệ, Quận 1, TP.HCM").build(),

                OrderEntity.builder().account(accounts.get(1)).status(OrderStatus.SHIPPING)
                        .subTotal(new BigDecimal("3800000")).finalTotal(new BigDecimal("3800000"))
                        .receiverName("Trần Thị Bình").receiverPhone("0912345678")
                        .receiverAddress("45 Trần Hưng Đạo, Quận 5, TP.HCM").build(),

                OrderEntity.builder().account(accounts.get(2)).status(OrderStatus.PROCESSING)
                        .subTotal(new BigDecimal("1200000")).finalTotal(new BigDecimal("1200000"))
                        .receiverName("Lê Văn Cường").receiverPhone("0923456789")
                        .receiverAddress("88 Lê Lợi, Quận 3, TP.HCM").build(),

                OrderEntity.builder().account(accounts.get(3)).status(OrderStatus.PAID)
                        .subTotal(new BigDecimal("5800000")).finalTotal(new BigDecimal("5800000"))
                        .receiverName("Phạm Thị Dung").receiverPhone("0934567890")
                        .receiverAddress("12 Hoàng Diệu, Quận 4, TP.HCM").build(),

                OrderEntity.builder().account(accounts.get(4)).status(OrderStatus.PENDING)
                        .subTotal(new BigDecimal("2300000")).finalTotal(new BigDecimal("2300000"))
                        .receiverName("Hoàng Văn Em").receiverPhone("0945678901")
                        .receiverAddress("67 Cách Mạng Tháng 8, Quận 10").build(),

                OrderEntity.builder().account(accounts.get(5)).status(OrderStatus.DELIVERED)
                        .subTotal(new BigDecimal("1500000")).finalTotal(new BigDecimal("1500000"))
                        .receiverName("Vũ Thị Phương").receiverPhone("0956789012")
                        .receiverAddress("30 Phan Đình Phùng, Phú Nhuận").build(),

                OrderEntity.builder().account(accounts.get(6)).status(OrderStatus.CANCELED)
                        .subTotal(new BigDecimal("3200000")).finalTotal(new BigDecimal("3200000"))
                        .receiverName("Đặng Văn Giang").receiverPhone("0967890123")
                        .receiverAddress("99 Đinh Tiên Hoàng, Bình Thạnh").build(),

                OrderEntity.builder().account(accounts.get(7)).status(OrderStatus.REFUNDED)
                        .subTotal(new BigDecimal("1900000")).finalTotal(new BigDecimal("1900000"))
                        .receiverName("Bùi Thị Hoa").receiverPhone("0978901234")
                        .receiverAddress("15 Lý Thường Kiệt, Tân Bình").build(),

                OrderEntity.builder().account(accounts.get(0)).status(OrderStatus.DELIVERED)
                        .subTotal(new BigDecimal("6600000")).finalTotal(new BigDecimal("6600000"))
                        .receiverName("Nguyễn Văn An").receiverPhone("0901234567")
                        .receiverAddress("123 Nguyễn Huệ, Quận 1, TP.HCM").build(),

                OrderEntity.builder().account(accounts.get(8)).status(OrderStatus.PROCESSING)
                        .subTotal(new BigDecimal("2600000")).finalTotal(new BigDecimal("2600000"))
                        .receiverName("Ngô Văn Inh").receiverPhone("0989012345")
                        .receiverAddress("22 Trường Chinh, Quận 12").build()
        ));
        log.info("Seeded {} orders", orders.size());

        // ===================== ORDER ITEMS (15 bản ghi) =====================
        orders.get(0).getItems().add(OrderItemEntity.builder().order(orders.get(0)).variant(v1).quantity(1).unitPrice(new BigDecimal("2990000")).build());
        orders.get(1).getItems().add(OrderItemEntity.builder().order(orders.get(1)).variant(v3).quantity(1).unitPrice(new BigDecimal("3800000")).build());
        orders.get(2).getItems().add(OrderItemEntity.builder().order(orders.get(2)).variant(v9).quantity(1).unitPrice(new BigDecimal("1200000")).build());
        orders.get(3).getItems().add(OrderItemEntity.builder().order(orders.get(3)).variant(v6).quantity(1).unitPrice(new BigDecimal("5800000")).build());
        orders.get(4).getItems().add(OrderItemEntity.builder().order(orders.get(4)).variant(v5).quantity(1).unitPrice(new BigDecimal("2300000")).build());
        orders.get(5).getItems().add(OrderItemEntity.builder().order(orders.get(5)).variant(v10).quantity(1).unitPrice(new BigDecimal("1200000")).build());
        orders.get(5).getItems().add(OrderItemEntity.builder().order(orders.get(5)).variant(v12).quantity(1).unitPrice(new BigDecimal("1500000")).build());
        orders.get(6).getItems().add(OrderItemEntity.builder().order(orders.get(6)).variant(v8).quantity(1).unitPrice(new BigDecimal("3200000")).build());
        orders.get(7).getItems().add(OrderItemEntity.builder().order(orders.get(7)).variant(v13).quantity(1).unitPrice(new BigDecimal("1900000")).build());
        orders.get(8).getItems().add(OrderItemEntity.builder().order(orders.get(8)).variant(v4).quantity(1).unitPrice(new BigDecimal("3800000")).build());
        orders.get(8).getItems().add(OrderItemEntity.builder().order(orders.get(8)).variant(v7).quantity(1).unitPrice(new BigDecimal("5800000")).build());
        orders.get(9).getItems().add(OrderItemEntity.builder().order(orders.get(9)).variant(v15).quantity(1).unitPrice(new BigDecimal("2600000")).build());
        orders.get(0).getItems().add(OrderItemEntity.builder().order(orders.get(0)).variant(v11).quantity(1).unitPrice(new BigDecimal("1500000")).build());
        orders.get(2).getItems().add(OrderItemEntity.builder().order(orders.get(2)).variant(v17).quantity(1).unitPrice(new BigDecimal("2100000")).build());
        orders.get(1).getItems().add(OrderItemEntity.builder().order(orders.get(1)).variant(v20).quantity(1).unitPrice(new BigDecimal("3000000")).build());
