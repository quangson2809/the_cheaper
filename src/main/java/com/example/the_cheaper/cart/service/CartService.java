package com.example.the_cheaper.cart.service;

import com.example.the_cheaper.cart.dto.request.user.UserAddCartItemRequest;
import com.example.the_cheaper.cart.dto.request.user.UserMergeCartRequest;
import com.example.the_cheaper.cart.dto.request.user.UserUpdateCartItemRequest;
import com.example.the_cheaper.cart.dto.response.user.UserCartItemResponse;
import com.example.the_cheaper.cart.dto.response.user.UserCartOverviewResponse;
import com.example.the_cheaper.cart.dto.response.user.UserCartResponse;
...
import com.example.the_cheaper.cart.mapper.user.UserCartMapper;
import com.example.the_cheaper.cart.repository.CartItemRepository;
import com.example.the_cheaper.cart.repository.CartRepository;
