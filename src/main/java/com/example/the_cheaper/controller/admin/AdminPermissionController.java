...
public class AdminPermissionController {
    ...
    public ResponseEntity<ApiResponse<Page<AdminPermissionResponse>>> listPermissions(
        ...
        Page<AdminPermissionResponse> response =
                adminPermissionService.listPermissions(page, size, currentUser);
        return ResponseEntity.ok(
                ApiResponse.success(response, "Lấy danh sách permission thành công"));
    }
    ...
    public ResponseEntity<ApiResponse<AdminPermissionResponse>> getPermission(
            ...
            @CurrentUser AccountEntity currentUser) {
        AdminPermissionResponse response =
                adminPermissionService.getPermission(id, currentUser);
        return ResponseEntity.ok(
                ApiResponse.success(response, "Lấy permission thành công"));
    }
    ...
    public ResponseEntity<ApiResponse<AdminPermissionResponse>> createPermission(
            ...
            @CurrentUser AccountEntity currentUser) {
        AdminPermissionResponse response =
                adminPermissionService.createPermission(request, currentUser);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(response, "Tạo permission thành công"));
    }
    ...
    public ResponseEntity<ApiResponse<AdminPermissionResponse>> updatePermission(
            ...
            @CurrentUser AccountEntity currentUser) {
        AdminPermissionResponse response =
                adminPermissionService.updatePermission(id, request, currentUser);
        return ResponseEntity.ok(
                ApiResponse.success(response, "Cập nhật permission thành công"));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deletePermission(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(null, "Xóa permission thành công"));
    }
}
