...
public class AdminRolePermissionController {
    ...
    public ResponseEntity<ApiResponse<List<AdminRolePermissionResponse>>> getPermissions(
        ...
        List<AdminRolePermissionResponse> response =
                adminRolePermissionService.getPermissions(roleId, currentUser);
        return ResponseEntity.ok(
                ApiResponse.success(response, "Lấy permission của role thành công"));
    }
    ...
    public ResponseEntity<ApiResponse<List<AdminRolePermissionResponse>>> replacePermissions(
            ...
            @CurrentUser AccountEntity currentUser) {
        List<AdminRolePermissionResponse> response =
                adminRolePermissionService.replacePermissions(roleId, request, currentUser);
        return ResponseEntity.ok(
