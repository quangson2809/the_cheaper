package com.example.the_cheaper.dashboard.controller.admin;

import com.example.the_cheaper.config.Shared;
import com.example.the_cheaper.common.dto.ApiResponse;
import com.example.the_cheaper.dashboard.dto.request.admin.AdminDashboardStatsRequest;
import com.example.the_cheaper.dashboard.dto.request.SearchRequest;
import com.example.the_cheaper.dashboard.dto.response.admin.AdminDashboardResponse;
import com.example.the_cheaper.common.exception.NotImplementedException;
import com.example.the_cheaper.dashboard.service.AdminDashboardService;
...
import com.example.the_cheaper.dashboard.dto.response.admin.MonthlyQuantityResponse;
import com.example.the_cheaper.dashboard.dto.response.admin.MonthlyRevenueResponse;
import com.example.the_cheaper.dashboard.dto.response.admin.OrderStatusRatioResponse;
